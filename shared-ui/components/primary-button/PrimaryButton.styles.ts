...
const StyledPrimaryButton = styled(motion.button)<StyledPrimaryButtonProps>`
  ...
  padding-right: ${(props): string => props.isSmallPrimary === true ? '0.5em' : '1em'};
  padding-left: ${(props): string => props.isSmallPrimary === true ? '0.5em' : '1em'};
  padding-right: ${(props): string => props.isSmallPrimary === true ? '1.5em' : '1em'};
  padding-left: ${(props): string => props.isSmallPrimary === true ? '1.5em' : '1em'};
  border-radius: 2em;
  border: 0.1em solid;
  cursor: pointer;
  font-size: 1.4em;
